...
<nav id="sidebar">
    ...
    <ul class="list-unstyled components" role="tablist">
      ...
      <li class="height_100 w-100">
        <a href="healthcareWorkers.php" class="height_100 padding_0" aria-selected="true">Healthcare Workers</a>
      </li>
      <li class="height_100 w-100">
        <a href="facilities.php" class="height_100 padding_0" aria-selected="true">Facilities</a>
      </li>
      <li class="height_100 w-100">
      ...
      <li class="height_100 w-100">
        <a href="shipmentReceive.php" class="height_100 padding_0" aria-selected="true">Shipments</a>
      </li>
      <li class="height_100 w-100">
    ...
    <p style="font-weight: bold; color: #95a5a6;padding-left: 10px" class="margin_0 padding_top">
        USEFUL LINKS
    </p>
    <ul class="list-unstyled components" role="tablist" style="padding-top:5px;">
      <li class="height_100 w-100">
